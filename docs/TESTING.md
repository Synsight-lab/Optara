...
Implemented: `contract/test/{unit,core,fuzz,invariant,integration,deploy,mocks,utils}`, `indexer/test`,
`frontend/src/**/*.test.ts(x)`, `test-vectors/`. Package tests run in the SDK repository.
`contract/test/TRACEABILITY.md` (generated by `contract/script/traceability.py`) maps every TEST_CASES ID.
